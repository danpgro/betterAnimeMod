...
import betterAnimeMod.patches.relics.BottledPlaceholderField;
import betterAnimeMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static betterAnimeMod.DefaultMod.makeRelicOutlinePath;
import static betterAnimeMod.DefaultMod.makeRelicPath;
